...
use peer_practice_shared::sessions::SessionInformation;
                            ...
                            >
                                <TextInput
                                    ...
                                    on_input=Callback::new(move |ev| {
                                        state.send(
                                            ClientToServer::Session(
                                                SessionAction::UpdateSession(SessionInformation {
                                                    session_id: id,
                                    ...
                                    placeholder="Your device (eg. Chrome Browser Laptop)"
                                        .to_string()
                                />
                                <ServerButton
