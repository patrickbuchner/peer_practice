...
mod transformations_v2026_01_11 {
    use crate::v2026_02_07::messages::client_to_server::{ChatAction, ClientToServer, PostAction, UserAction};
        ...
        fn from(value: ClientToServer) -> Self {
            match value {
                ...
                ClientToServer::Post(PostAction::UpdatePost(id, post)) => Self::Post(
                    crate::v2026_01_11::messages::client_to_server::PostAction::UpdatePost(id, post),
                ),
                ...
                ClientToServer::Post(PostAction::GetPostMessages(id)) => Self::Post(
                    crate::v2026_01_11::messages::client_to_server::PostAction::GetPostMessages(id),
                ),
    ...
    impl From<crate::v2026_01_11::messages::ClientToServer> for ClientToServer {
        fn from(value: crate::v2026_01_11::messages::ClientToServer) -> Self {
            ...
            match value {
                ...
                Old::User(crate::v2026_01_11::messages::client_to_server::UserAction::Update(user)) => {
                ...
                Old::Post(crate::v2026_01_11::messages::client_to_server::PostAction::Leave(id)) => {
                    Self::Post(PostAction::Leave(id))
                }
                Old::Post(crate::v2026_01_11::messages::client_to_server::PostAction::UpdatePost(id, post)) => {
                    Self::Post(PostAction::UpdatePost(id, post))
                }
                Old::Post(crate::v2026_01_11::messages::client_to_server::PostAction::NewPost(post)) => {
                    Self::Post(PostAction::NewPost(post))
                }
                Old::Post(crate::v2026_01_11::messages::client_to_server::PostAction::DeletePost(id)) => {
                    Self::Post(PostAction::DeletePost(id))
                }
                Old::Post(crate::v2026_01_11::messages::client_to_server::PostAction::GetPostMessages(id)) => {
                    Self::Post(PostAction::GetPostMessages(id))
                }

                Old::Chat(crate::v2026_01_11::messages::client_to_server::ChatAction::GetChatFor(id)) => {
                    Self::Chat(ChatAction::GetChatFor(id))
                }
                Old::Chat(crate::v2026_01_11::messages::client_to_server::ChatAction::GetChat(id)) => {
                    Self::Chat(ChatAction::GetChat(id))
                }
                Old::Chat(crate::v2026_01_11::messages::client_to_server::ChatAction::SendMessage(msg)) => {
